...
　フェンシングの種目のひとつにサーブルという種目があります。そのサーブルで立ち合いと呼ばれる場面があり、その場面における戦略で、どういう戦略が強いのかを考察しています。手法としてはサーブルの試合をコードを書いてコンピューター上で再現して、いろいろな戦略を持ったプレイヤー同士を対戦させてその勝率を計算しています。
